...
public class Defaulter extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable(){
        try {
            ...
            ResultSet rs = st.executeQuery("select * from issue_book_details where due_date < '"+today+"' and status = '"+"pending"+"' ");
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 30, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 1110, 600));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Defaulter().setVisible(true));
    }
